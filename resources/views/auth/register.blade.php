                    ...
                    <form action="{{ route('register') }}" method="post">
                        ...
                        <div class="
                            ...
                            <div class="mb-4">
                                ...
                                <select type="text" id="gender" name="gender" class="
										block
										w-full
										mt-1
										border
                            ...
                            <div class="grid grid-cols-12 gap-6">
                                <div class="col-span-4">
                                    <div class="mb-4">
                                        ...
                                        <select type="text" id="day" name="day" class="
												block
												w-full
												mt-1
												border
                            ...
                            <div class="mb-4">
                                ...
                                <x-input type="email" id="email" name="email" :value="old('email')"
                                    placeholder="name@email.com" class="@error('email') border-red-500 @enderror" />
                                --}}
        ...
        <div class="
            ...
            <div class="flex flex-wrap items-center -mx-3">
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        ...
                        <ul>
                            ...
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <i class="bx bx-calendar-heart text-yellow-500 bx-md bx-fw"></i>
                ...
                <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0">
                    <img class="mx-auto sm:max-w-sm lg:max-w-full" src="img/bg_love.svg" alt="feature image" />
                </div>
            </div>
        </div>
    </section>
